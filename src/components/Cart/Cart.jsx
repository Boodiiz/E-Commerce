  ...
  <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
    ...
    <tbody>
      ...
      <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
        <td className="bg-white border-b text-center text-xl dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600" colSpan={2}>Total Price</td>  
        <td className="bg-white border-b dark:bg-gray-800 text-center text-xl dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600" colSpan={3}>= {totalPrice} EGP</td>  
        <td>
          <NavLink className=' bg-green-600 text-white text-xl mx-4 px-10 font-semibold rounded-md' colSpan={2} to='checkout'>Checkout</NavLink>
        </td>
      </tr>
    </tbody>
  </table>
